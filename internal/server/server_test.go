...
import (
	...
	"github.com/egoholic/proglog/internal/auth"
	"github.com/egoholic/proglog/internal/config"
	"github.com/egoholic/proglog/internal/log"
...
func TestServer(t *testing.T) {
	scenarios := map[string]func(
		...
		"produce/consume a mesage to/from the log succeeds": testProduceConsume,
